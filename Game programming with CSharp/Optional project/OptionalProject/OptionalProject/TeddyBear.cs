...
namespace OptionalProject
{
    ...
    public class TeddyBear
    {
        ...
        {
            // move the teddy bear
            double millisecs = gameTime.ElapsedGameTime.TotalMilliseconds;
            int xOffset = (int)(this.Velocity.X * millisecs);
            int yOffset = (int)(this.Velocity.Y * millisecs);
            this.drawRectangle.Offset(xOffset, yOffset);
